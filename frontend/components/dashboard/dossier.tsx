        ...
        <DialogContent>
          ...
          <DialogFooter className="mt-6 gap-2">
            <button
              ...
              disabled={isDeleting}
              className="border-border bg-card hover:bg-foreground/4 hover:border-border/80 focus-visible:border-foreground focus-visible:ring-foreground/30 focus-visible:bg-foreground/4 focus-visible:ring-2 focus-visible:ring-offset-0 text-foreground/90 hover:text-foreground focus-visible:text-foreground inline-flex items-center justify-center rounded-sm border px-4 py-2 font-mono text-[11px] uppercase tracking-[0.08em] transition-colors duration-150 focus-visible:outline-none disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              disabled={isDeleting}
              className="bg-risk-high text-background hover:bg-risk-high/90 focus-visible:ring-risk-high/40 inline-flex items-center justify-center rounded-sm border border-transparent px-4 py-2 font-mono text-[11px] uppercase tracking-[0.08em] transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-none disabled:opacity-60"
            >
...
function ContractRow({
  ...
  return (
    <tr className="border-border/40 group hover:bg-muted/60 relative border-b transition-colors duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] last:border-b-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-44">
            <DropdownMenuItem
              ...
              className="text-risk-high focus:bg-risk-high/8 focus:text-risk-high cursor-pointer font-mono text-[11px] uppercase tracking-[0.08em]"
            >
              Delete contract
            </DropdownMenuItem>
          </DropdownMenuContent>
